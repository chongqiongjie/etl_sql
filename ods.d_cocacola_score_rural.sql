 ...
 --**********************************
  ...
  \c dw ;
  CREATE TABLE IF NOT EXISTS stg.d_cocacola_score_rural_rng (
    dw_start_dt CHAR(10),
    dw_end_dt CHAR(10),
    dw_in_use CHAR(1),
    dw_ld_cnt INT,
  ...
  CREATE TABLE IF NOT EXISTS ods.d_cocacola_score_rural (
    dw_dt CHAR(10),
    period TEXT,
    mbd TEXT,
    bg TEXT,
  ...
  update stg.d_cocacola_score_rural_rng set dw_in_use = '0' where dw_in_use = '1' ;
  insert into stg.d_cocacola_score_rural_rng (
    dw_start_dt,
    dw_end_dt,
    dw_in_use,
    dw_ld_cnt,
  ...
  from stg.d_cocacola_score_rural ;

  delete from ods.d_cocacola_score_rural ods
  using stg.d_cocacola_score_rural_rng rng
  where rng.dw_in_use = '1'
  and ods.dw_dt between rng.dw_start_dt and rng.dw_end_dt ;

  insert into ods.d_cocacola_score_rural (
    dw_dt,
    period,
    mbd,
    bg,
